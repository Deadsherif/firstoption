...
namespace GetElementRoom
{
    internal class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication a)
        {
            ...
            //Buttons
            #region Buttons
            PushButton button = panel.AddItem(new PushButtonData("Get Element Room", "Get Element Room", thisassemblypath, "GetElementRoom.Command")) as PushButton;
        ...
        public RibbonPanel ribbonpanel(UIControlledApplication a)
        {
            ...
            try
            {
                ...
                RibbonPanel panel = a.CreateRibbonPanel(tab, "Common");
            }
            catch { }
