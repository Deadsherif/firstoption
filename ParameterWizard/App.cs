...
namespace ParameterWizard
{
    public class App : IExternalApplication
    {
        ...
        {
            //Panel
            RibbonPanel panel = ribbonpanel(a, "First Option", "Shop Drawing");
            //Assemblylocation
            string thisassemblypath = Assembly.GetExecutingAssembly().Location;
            //Images
            #region Images
            var img = Properties.Resources.wizard;
            ImageSource imgsc = GetImageSource(img);

            #endregion
            //Buttons
            #region Buttons
            PushButton button = panel.AddItem(new PushButtonData("ParameterWizard", "Parameter Wizard", thisassemblypath, "ParameterWizard.Command")) as PushButton;
