...
namespace AlignCenter
{
    public class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication a)
        {
            ...
            //Images
            #region Images
            var img = Properties.Resources.mirror;
            ImageSource imgsc = GetImageSource(img);

            #endregion
            //Buttons
            #region Buttons
            PulldownButton pulldownButton = GetPulldownButtonData(panel, "Align", "Align",Properties.Resources.align_left);
            var pushbuttonData = new PushButtonData("AlignCenter", "Align Center", thisassemblypath, "AlignCenter.Command");
            pushbuttonData.Image = imgsc;
            pushbuttonData.LargeImage = imgsc;
