...
namespace AutoTrim
{
    public class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication a)
        {
            ...
            //Images
            #region Images
            var img = Properties.Resources.scissors;
            ImageSource imgsc = GetImageSource(img);

            #endregion
            //Buttons
            #region Buttons
            PushButton button = panel.AddItem(new PushButtonData("AutoTrim", "Auto Trim", thisassemblypath, "AutoTrim.Command")) as PushButton;
