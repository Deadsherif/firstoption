...
namespace Firebase.Auth.UI
{
   ...
   public class FirebaseUI
   {
      ...
      private FirebaseUI(FirebaseUIConfig config)
      {
         ...
         this.Client = new FirebaseAuthClie nt(config);
      ...
      {
         var fetchResult = await this.RetryAction(e => flow.PromptForEmailAsync(e), semail => this.Client.FetchSignInMethodsForEmailAsync(semail));
