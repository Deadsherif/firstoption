...
using FloorSlicer22.SelectionFilters;
                    ...
                    try
                    {
                        ...
                        if (FloorLayers.Count > 1)
                        {
                            ...
                            using (Transaction transaction = new Transaction(Doc, "Create New Floor"))
                            {
                                ...
                                List<CurveLoop> Loops = Helper.GetFloorCurveLoops(Doc, floor);
                                ...
                                {
                                    Floor NewFloor = Floor.Create(Doc, Loops, NewTypesCreated[i].Id, floor.LevelId);
