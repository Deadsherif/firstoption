...
namespace Divide_Floors
{
    ...
    {
        public static FootPrintRoof footprintRoof;
...

        {
            ...
            var paneltype = new FilteredElementCollector(doc).OfClass(typeof(PanelType)).Where(x => x.Name == "Glazed").FirstOrDefault();
        ...
        public static void DivideIt(Document doc)
        {
            ...
            try
            {
                ...
                var footprintRoof = Command.footprintRoof;
