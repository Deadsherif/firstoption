...
namespace Divide_Floors
{
    public class App : IExternalApplication
    {
        ...
        {
            //Panel
            RibbonPanel panel = ribbonpanel(a, "First Option", "Architecture");
            //Assemblylocation
            string thisassemblypath = Assembly.GetExecutingAssembly().Location;
            //Images
            #region Images
            var img = Properties.Resources.divide__1_;
            ImageSource imgsc = GetImageSource(img);

            #endregion
            //Buttons
            #region Buttons
            PushButton button = panel.AddItem(new PushButtonData("divideFloors", "Divide Floor", thisassemblypath, "Divide_Floors.Command")) as PushButton;
