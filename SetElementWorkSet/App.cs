...
namespace SetElementWorkSet
{
    public class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication a)
        {
            ...
            //Images
            #region Images
            var img = Properties.Resources.contribution;
            ...
            PushButtonData button = new PushButtonData("SetElementWorkSet", "Set Elements WorkSet", thisassemblypath, "SetElementWorkSet.Command");
