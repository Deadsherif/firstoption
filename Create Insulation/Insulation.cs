...
namespace Insulation
{
    ...
    {
        internal Solid JoinedSolid { get; set; }
        internal static  List<Solid> solids = new List<Solid>();
        internal static Solid solid;
        internal static List<PlanarFace> topfaceofcolumn = new List<PlanarFace>();
        internal static ElementId graphicstyleid;
