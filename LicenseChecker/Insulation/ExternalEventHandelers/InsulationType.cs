...
namespace Insulation.ExternalEventHandelers
{
    public class InsulationType : IExternalEventHandler
    {
        public void Execute(UIApplication app)
        {

            UIDocument uidoc = app.ActiveUIDocument;
            Insulation.MVVM.Model.Insulation ins = new Insulation.MVVM.Model.Insulation();
            ...
            {
                Insulation.MVVM.Model.Insulation.solids.Clear();
                Insulation.MVVM.Model.Insulation.Insulatebyselection(uidoc, doc);
                var faceArrayfinal = Insulation.MVVM.Model.Insulation.GetFaceArray();
            ...
            {
                Insulation.MVVM.Model.Insulation.solids.Clear();
                Insulation.MVVM.Model.Insulation.Insulatebylevel(uidoc, doc, Database.selectedlevel.Name);
                var faceArrayfinal = Insulation.MVVM.Model.Insulation.GetFaceArray();
            ...
            else if (xname == "By Face")
            {
                ...
                Transaction mtr = new Transaction(doc, "modeling transaction");
                mtr.Start();
                Insulation.MVVM.Model.Insulation.ModelInsulationOneFace(doc, face, Database.thickness, Database.selectedcategory, Database.booloffset);
                mtr.Commit();
