...
namespace AlignTags
{
    public class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication a)
        {
            ...
            //Images
            #region Images
            var img = Properties.Resources.tags;
            ImageSource imgsc = GetImageSource(img);

            #endregion
            //Buttons
            #region Buttons
            PulldownButton pulldownButton = GetPulldownButtonData(panel, "Align", "Align",Properties.Resources.format);
            PushButtonData button = new PushButtonData("AlignTags", "Align Tags", thisassemblypath, "AlignTags.Command");
        ...
        {
            var targetItem = panel.GetItems().FirstOrDefault(x => x.Name == name);
            if (targetItem != null)
            {
            ...
            else
            {
                ...
                ImageSource imgsc = GetImageSource(img);
                #endregion
                pulldownButtonData.Image = imgsc;
                pulldownButtonData.ToolTipImage = imgsc;
